...
{
    public class PAWalkingState : PABaseState
    {
        private float _currentSpeed;

        public PAWalkingState(PlayerAimingController controller) : base(controller)
        {
        }
        ...
        {
            float targetSpeed = _controller.MovementProfile.WalkSpeed;
