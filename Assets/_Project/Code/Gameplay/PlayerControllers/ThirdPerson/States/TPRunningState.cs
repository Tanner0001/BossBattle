...
{
    public class TPRunningState : TPBaseState
    {
        private float _currentSpeed;

        public TPRunningState(ThirdPersonController controller) : base(controller)
        {
        }
        ...
        {
            var targetSpeed = _controller.MovementProfile.RunSpeed;
